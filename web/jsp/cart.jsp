...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <body>
		...
		<div class="container">
            ...
            <c:choose>
                        <c:when test= "${requestScope.cartProducts!=null}">  
                        <div class="productContainer">
                  
                
                        <c:forEach items="${requestScope.cartProducts}" var="product" varStatus="Loop">
			<form >
                            
				<div class="productContainerItem">
                                    	<img id="pic3" src="${product.productImgPath}"> 
                                        <input type="text" name="product" value="${product.productName}">
                                        <br/> 
