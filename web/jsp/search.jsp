	...
	<section id="products" class="section">
		<div class="container">
			...
			<p>
				...
				high-quality, nutrient-rich, nutritional products that <em>enhance
					active lifestyles</em>.
                        ...
                        <span id="size"
                              title= "hello"<%--"${sessionScope.getAttribute("cart")}" --%> > Items
                            in Cart: ${cart.size()}</span>
                         </c:when>    
                         <c:otherwise>      
			<span id="size">Items in Cart: 0</span>
               ...
               <c:if test="${requestScope.searchResults != null}">  
		<div class="productContainer">
                  
                
                        <c:forEach items="${requestScope.searchResults}" var="products" varStatus="Loop">
			<form method="get" action="products">
                            
				<div class="productContainerItem">
					<img id="pic3" src="${products.productImgPath}"> <input
						type="text" name="product" value="${products.productName}"><br />
